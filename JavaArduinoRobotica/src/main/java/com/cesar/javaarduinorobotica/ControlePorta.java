...
public class ControlePorta {
    ...
    private void initialize() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro de comunicação com o arduino:" + e.getMessage()
            );
        }
    }
    ...
    /**
     * @param opcao - Dados a ser enviado pela porta serial
     */
    public void enviaDados(byte[] dados) {
        try {
            serialOut.write(dados);//escreve o valor na porta serial para ser enviado
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Não foi possível enviar o comando. ",
